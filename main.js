  ...
  try {
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <button id='dynamicButton' onclick="card1()">for more</button>
      </div>
    </div>
  </div>`;
    });
...
function createNewUser() {
  ...
  if (
    ...
    <div class="card h-100">
      ...
      cardsSecondContainerId.innerHTML += `<tr><th scope="row">${counterForTableNumbers++}</th>
    <td>${catchUserClassShow.firstName}</td>>
    <td>${catchUserClassShow.lastName}</td>>
    <td>${catchUserClassShow.age}</td>>
    <td>${catchUserClassShow.email}</td>>
...
function goBack() {
  ...
  <form id="survey-form" onsubmit="return false">
    <div class="form-group">
      <label id="name-label" for="name">firs Name</label>
      <input
        type="text"
        name="firsName"
        id="firstName"
    ...
    <div class="form-group">
      <label id="email-confirm-label" for="email-confirm"
        >Email-confirm</label
      >
      <input
        type="email"
    ...
    <div class="form-group">
      <button id="submit" class="submit-button" onclick="createNewUser()">
        Submit
      </button>
      <button
        onclick="cancelAddUserBtn()"
        id="cancel"
        class="cancel-button"
      >
        cancel
...
<div id="main">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="image001.png" alt="" height="60px" /> </a
      ><a class="navbar-brand" href="#">
        <img src="indi_com.png" alt="" height="60px" />
      </a>
  ...
  <div class="container top-buttons d-flex justify-content-evenly">
    <button
    ...
    <button id="addButtonId" class="btn btn-success" onclick="addUserBtn()">
      הוספה
    </button>
  </div>
  <div class="container" id="tableAndCardsContainer">
  <div
  id="cardsSecondContainerId"
  class="row row-cols-1 row-cols-md-4 g-4">
  ${catchcardsCreation}
...
<footer class="footer">
  <div class="container">
    ...
    <h5 class="text-center">
      Copyright @2021 | Designed With by <strong> Yuda Bayana</strong>
    </h5>
